...
function db_connect() {
    ...
    if (mysqli_connect_errno()) {
        ...
        // There are 3 places to check to make sure we have the correct character encoding: the database, our HTML document, and here, in out MySQLi connection handle
