...
// This script will hand form data and process uploaded images
...
<section class="row justify-content-center my-5">
    <div class="col-md-6">
        ...
        <!-- Preview: If theres a newly created image, we'll show a preview of it to the user -->
        ...
        <!-- Enctype: This attribute is used to specify encoding format, in which the data submitted in the form has to be encoded before sending it to the server. This attrivute is very important and without specifying this, the image will not be uploaded to the server -->
        <form action="<?=  htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
            <!-- Image title -->
             <div class="mb-3">
                <label for="image-title" class="form-label">Image Title</label>
                <input type="text" id="image-title" name="image-title" value="<?= $img_title; ?>" maxlength="50" class="form-control">
            ...
            <!-- Image description -->
             <div class="mb-3">
                ...
                <input type="text" id="img-description" name="img-description" value="<?= $img_description; ?>" maxlength="255" class="form-control">
            ...
            <!-- Submit -->
            <input type="submit" id="submit" name="submit" value="Upload Image" class="btn btn-primary mt-5">
        </form>
